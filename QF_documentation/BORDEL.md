...
Verdict: voie choisie par l'oracle
Recommandation: phrase prononcée par l'Oracle
Decision: voie prise par l'user
Aventure (=quest): dilemme complété
Portée (=scope): dans 10 jours, ça compte ? Q0 ou Q4 dans les archives.
PV (HP): energy/spoons dans les archives.
